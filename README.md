...
These are the files for the ebook Learn C Games Programming for beginners on Linux which is now available on [Amazon (UK)]([url](https://amzn.eu/d/87tHW3A)). All graphics and sounds files are included.
